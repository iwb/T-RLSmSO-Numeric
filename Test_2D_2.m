...
% Test_2D_2.m
%
% Model exported on Oct 4 2013, 21:39 by COMSOL 4.3.1.161.
...
model.geom('geom1').feature('r2').active(false);
model.geom('geom1').feature('r2').set('size', {'1' '5'});
model.geom('geom1').feature('r2').set('pos', {'10' '5'});
model.geom('geom1').feature('r3').set('size', {'1' '5'});
model.geom('geom1').feature('r3').set('pos', {'12' '5'});
model.geom('geom1').feature('r4').active(false);
model.geom('geom1').feature('r4').set('size', {'1' '5'});
model.geom('geom1').feature('r4').set('pos', {'20' '5'});
...
model.study('std1').feature('time2').set('tlist', '0.2');
model.study('std1').feature('time2').set('autoremesh', 'on');
...
model.sol('sol2').attach('std1');
model.sol('sol2').feature('st1').name('Compile Equations: Time Dependent');
...
model.result('pg1').set('edgecolor', 'blue');
