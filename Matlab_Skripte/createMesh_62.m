...
model.mesh('mesh1').feature('ftet1').feature('size1').set('hgrad', '1.3');         % 1.2
model.mesh('mesh1').feature('ftet1').feature('size1').set('hcurveactive', 'on');
model.mesh('mesh1').feature('ftet1').feature('size1').set('hcurve', '1.6');         % 1.2
