...
model.mesh('mesh1').feature('ftet1').feature('size1').set('hmax', '80 [µm]');       % 60
...
model.mesh('mesh1').feature('ftet1').feature('size1').set('hgrad', '1.62');         % 1.2
model.mesh('mesh1').feature('ftet1').feature('size1').set('hcurveactive', 'on');
model.mesh('mesh1').feature('ftet1').feature('size1').set('hcurve', '2.2');         % 1.2
model.mesh('mesh1').feature('ftet1').feature('size1').set('hnarrowactive', 'on');
model.mesh('mesh1').feature('ftet1').feature('size1').set('hnarrow', '0.05');       % 0.1

%% Coarse Mesh outside
model.mesh('mesh1').feature.create('ftet2', 'FreeTet');
model.mesh('mesh1').feature('size').set('custom', 'on');
model.mesh('mesh1').feature('size').set('hmax', '0.6 [mm]');
model.mesh('mesh1').feature('size').set('hmin', '80 [µm]');                         % 60
