...
model.mesh('mesh1').feature('ftet1').feature('size1').set('hmax', '80 [µm]');
...
model.mesh('mesh1').feature('ftet1').feature('size1').set('hcurve', '1.8');
model.mesh('mesh1').feature('ftet1').feature('size1').set('hnarrowactive', 'on');
model.mesh('mesh1').feature('ftet1').feature('size1').set('hnarrow', '0.04');

%% Coarse Mesh outside
model.mesh('mesh1').feature.create('ftet2', 'FreeTet');
model.mesh('mesh1').feature('size').set('custom', 'on');
model.mesh('mesh1').feature('size').set('hmax', '1.1 [mm]');
model.mesh('mesh1').feature('size').set('hmin', '80 [µm]');
