function out = model
%
% comsol_init_histreset.m
%
% Model exported on Oct 8 2013, 14:34 by COMSOL 4.3.1.161.
...
model.geom('geom1').feature('r2').set('pos', {'10' '6'});
...
model.view('view1').axis.set('xmin', '-1.395477294921875');
model.view('view1').axis.set('ymin', '-12.131921768188477');
model.view('view1').axis.set('xmax', '42.27950668334961');
model.view('view1').axis.set('ymax', '24.714618682861328');
...
model.physics('ht').feature('init2').set('T', '3000');
model.physics('ht').feature('init2').name(['W' native2unicode(hex2dec('00e4'), 'Cp1252') 'rmequelle']);
model.physics('ht').feature('temp1').set('T0', '3000');
